                ...
                <asp:TemplateField HeaderStyle-BackColor="#007bff" HeaderStyle-ForeColor="White">
                    <ItemTemplate>
                        ...
                        <div id="btnEditOrgdiv" style="float: right; margin-right: 81px; padding-right: -59px;">
                            <asp:Button runat="server" Text="Edit ORG" ID="btnEditOrg" class="btn btn-primary" CommandName="PA" OnClick="editOrg" Style="height: 30px; padding-top: 3px; margin-right: -85px;"></asp:Button>
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
