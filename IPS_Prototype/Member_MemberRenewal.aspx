...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <label class="title">Membership Renewal</label>
    ...
    <table>
        <tr>
            <td>
                <div style="margin-left:40px;margin-right: 5px" class="btn-group btn-group-inline">
...
<br />
  ...
  <asp:Panel ID="panOrg" runat="server">
    <div runat="server" id="organisation">
        <asp:GridView PagerStyle-HorizontalAlign="Right" CssClass="table table-hover BlueTable pagination-ys" ID="gvOrg" PageSize="5" AllowPaging="true" OnPageIndexChanging="gvOrg_PageIndexChanging" OnRowDataBound="gvOrg_RowDataBound" runat="server" OnRowEditing="gvOrg_RowEditing" EmptyDataText="No Records Found" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false" GridLines="None" UseAccessibleHeader="true" BorderStyle="None">
            <Columns>
                ...
                <asp:BoundField DataField="ORG_ID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
                 <asp:BoundField DataField="CONTRIBUTION_STATUS" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
                <asp:BoundField DataField="CONTRIBUTION_ID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" /> 
                   ...
                   <asp:TemplateField HeaderStyle-BackColor="#007bff" HeaderStyle-ForeColor="White">
                    <ItemTemplate>
                        <asp:Button ID="btnRenewOrg" OnClick="btnRenewOrg_Click" Style="display: block; text-align: center; cursor: pointer; width: 60px !important; height: 30px !important; border: none; padding-top: 3px; background-color: #33b5e5!important; color: white; border-radius: 3px;" runat="server" Text="Renew" />
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderStyle-BackColor="#007bff" HeaderStyle-ForeColor="White">
                    <ItemTemplate>
                        <asp:Button ID="btnTEROrg" OnClick="btnTEROrg_Click" Style="display: block; text-align: center; cursor: pointer; width: 60px !important; height: 30px !important; border: none; padding-top: 3px; background-color: #2bbbad!important; color: white; border-radius: 3px;" runat="server" Text="TER"
...
<%--                <asp:CommandField EditText="Renew" ShowEditButton="true" HeaderStyle-BackColor="#007bff" HeaderStyle-ForeColor="White" />--%>
                <asp:TemplateField HeaderStyle-BackColor="#007bff" HeaderStyle-ForeColor="White">
                    <ItemTemplate>
                        <asp:Button Visible='<%#bool.Parse( HasMemberPaidOrg((int)(Eval("ORG_ID")))) %>' ID="btnViewContributionOrg" OnClick="btnViewContributionOrg_Click" Style="display: block; text-align: center; cursor: pointer; height: 30px !important; border: none; padding-top: 3px; background-color:#ff7043!important; color: white; border-radius: 3px;" runat="server" Text="View Contribution History"/>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
...
<asp:Panel ID="panPerson" runat="server">
    <div runat="server" id="person" >
        <asp:GridView PagerStyle-HorizontalAlign="Right" CssClass="table table-hover BlueTable personTable pagination-ys" PageSize="5" AllowPaging="true" OnPageIndexChanging="gvPerson_PageIndexChanging" OnRowDataBound="gvPerson_RowDataBound" Style="max-width: 100%" ID="gvPerson" class="table table-striped" DataKeyNames="PERSON_ID" EmptyDataText="No Records Found" ShowHeaderWhenEmpty="true" OnRowEditing="gvPerson_RowEditing" runat="server" AutoGenerateColumns="false" GridLines="None" UseAccessibleHeader="true" BorderStyle="None">
            <Columns>
                ...
                <asp:BoundField DataField="CONTRIBUTION_ID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"  />
                 ...
                 <asp:TemplateField HeaderStyle-BackColor="#007bff" HeaderStyle-ForeColor="White">
                    <ItemTemplate>
                        <asp:Button ID="btnRenewInd" OnClick="btnRenewInd_Click" Style="display: block; text-align: center; cursor: pointer; width: 60px !important; height: 30px !important; border: none; padding-top: 3px; background-color: #33b5e5!important; color: white; border-radius: 3px;" runat="server" Text="Renew" />
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderStyle-BackColor="#007bff" HeaderStyle-ForeColor="White">
            <ItemTemplate>
                <asp:Button ID="btnTER" OnClick="btnTER_Click" style="display:block; text-align:center; cursor: pointer; width:60px !important; height:30px !important; border: none; padding-top:3px;background-color:#2bbbad!important;color:white; border-radius:3px;" runat="server" Text="TER" 
                Visible='<%#bool.Parse( HasMemberPaid((int)(Eval("PERSON_ID")))) %>'/>
                     ...
                     <asp:TemplateField HeaderStyle-BackColor="#007bff" HeaderStyle-ForeColor="White">
                    <ItemTemplate>
                        <asp:Button  Visible='<%#bool.Parse( HasMemberPaid((int)(Eval("PERSON_ID")))) %>' ID="btnViewContributionInd" OnClick="btnViewContributionInd_Click" Style="display: block; text-align: center; cursor: pointer; height: 30px !important; border: none; padding-top: 3px; background-color: #ff7043!important; color: white; border-radius: 3px;" runat="server" Text="View Contribution History"/>
                    </ItemTemplate>
                </asp:TemplateField>
<%--                <asp:CommandField EditText="Renew" ShowEditButton="true" HeaderStyle-BackColor="#007bff" HeaderStyle-ForeColor="White" />--%>
            </Columns>
