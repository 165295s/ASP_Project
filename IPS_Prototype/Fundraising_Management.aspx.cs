...
namespace IPS_Prototype
{
    public partial class Fundraising_Management : System.Web.UI.Page
    {
        ...
        {
           // ddlDate.Items.Insert(0, new ListItem("-All Dates-", "0"));
        ...
        //{
        //    string selectedValue = ddlDate.SelectedValue;
        //    if (selectedValue == "0")
        //    {
        //        //fr_donors.Attributes.CssStyle.Add("display", "block");
        //        //fr_donors2.Attributes.CssStyle.Add("display", "none");
        //        gvDonors.DataSource = fundraising.getAllDonors();
        //        gvDonors.DataBind();
        //    }
        //    else
        //    {
        //        //fr_donors2.Attributes.CssStyle.Add("display","block");
        //        //fr_donors.Attributes.CssStyle.Add("display", "none");
        //        gvDonors.DataSource = fundraising.getLatestDate();
        //        gvDonors.DataBind();
        //    }
        //}
