...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        $(document).ready(function () {
            ...
            //$("#ContentPlaceHolder1_User_Input_Confirm_Password").keyup(validatePassword);
        ...
        function validatePassword() {
            var password1 = $("#ContentPlaceHolder1_User_Input_Password").val();
            var password2 = $("#ContentPlaceHolder1_User_Input_Confirm_Password").val();



            if (password1 == password2) {
                $("#passwordfail").addClass("none");
                $("#passwordpass").removeClass("none");
            }
            else {
                $("#passwordfail").removeClass("none");
                $("#passwordpass").addClass("none");
        ...
        <div class="SubHeader">
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3" style="width: 550px;">
                    ...
                    <input class="form-control" type="text" onkeyup="checkIDAvailability()" placeholder="User ID" runat="server" id="User_Input_Username" style="border-top-right-radius: 3px; border-bottom-right-radius: 3px;"><div style="min-width: 200px !important;">
                        <i id="usernamefail" class="far fa-times-circle validateIconFail none">
                            <label style="font-size: 15px; margin-left: 10px;">UserID is in use</label></i><i id="usernamepass" class="far fa-check-circle validateIconPass none"><label style="font-size: 15px; margin-left: 10px;">UserID is available</label></i>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-group mb-3" style="width: 550px;">
                    ...
                    <input class="form-control" type="text" placeholder="Password" runat="server" id="User_Input_Password" style="border-top-right-radius: 3px; border-bottom-right-radius: 3px;"><div style="min-width: 200px !important;">
                        <%-- <i id="usernamefail" class="far fa-times-circle validateIconFail none">
                            <label style="font-size: 15px; margin-left: 10px;">UserID is in use</label></i><i id="usernamepass" class="far fa-check-circle validateIconPass none"><label style="font-size: 15px; margin-left: 10px;">UserID is available</label></i>--%>
                    </div>
                </div>
                ...
                <div class="input-group mb-3" style="width: 550px;">
                    ...
                    <input class="form-control" type="text" placeholder="Confirm Password" onkeyup="validatePassword()" runat="server" id="User_Input_Confirm_Password" style="border-top-right-radius: 3px; border-bottom-right-radius: 3px;"><div style="min-width: 200px !important;">
                         <i id="passwordfail" class="far fa-times-circle validateIconFail none">
                            <label style="font-size: 15px; margin-left: 10px;">Passwords Do Not Match !</label></i><i id="passwordpass" class="far fa-check-circle validateIconPass none"><label style="font-size: 15px; margin-left: 10px;">Password Match !</label></i>
                    </div>
                </div>
            </div>
