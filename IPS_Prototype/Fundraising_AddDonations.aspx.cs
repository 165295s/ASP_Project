...
namespace IPS_Prototype
{
    public partial class Fundraising_AddDonations : System.Web.UI.Page
    {
        ...
        protected void btnProceedProspectiveMember_ServerClick(object sender, EventArgs e)
        {
                ...
                if (rbYes.Checked)
                {
                if (validateProspectiveFields().Equals(true))
                {
                    prospectiveList.Add(prospective_txtFirstName.Value);
                    prospectiveList.Add(prospective_txtSurname.Value);
                    prospectiveList.Add(gender);
                ...
                {           //showProsModalErrorNoEvent
                if (validateProspectiveFieldsNoEvent().Equals(true))
                {
                    prospectiveList.Add(prospective_txtFirstName.Value);
                    prospectiveList.Add(prospective_txtSurname.Value);
                    prospectiveList.Add(gender);
        ...
        protected bool validateProspectiveFields()
        {
            if (string.IsNullOrEmpty(prospective_txtFirstName.Value.ToString()) || prospective_txtFirstName.Value.Trim().ToString().Equals(""))
            {
                ScriptManager.RegisterStartupScript(Page, GetType(), "script1", "showProsModalError('Please Check First Name Field');", true);
                return false;
            }
            else if (string.IsNullOrEmpty(prospective_txtSurname.Value.ToString()) || prospective_txtSurname.Value.Trim().ToString().Equals(""))
            {
                ScriptManager.RegisterStartupScript(Page, GetType(), "script1", "showProsModalError('Please Check Surname Field.');", true);
                return false;
            }
            else if (string.IsNullOrEmpty(prospective_txtEmail.Value.ToString()) || prospective_txtEmail.Value.Trim().ToString().Equals(""))
            {
                ScriptManager.RegisterStartupScript(Page, GetType(), "script1", "showProsModalError('Please Check Email Field.');", true);
                return false;
            }
            else if (string.IsNullOrEmpty(prospective_txtTelephone.Value.ToString()) || prospective_txtTelephone.Value.Trim().ToString().Equals(""))
            {
                ScriptManager.RegisterStartupScript(Page, GetType(), "script1", "showProsModalError('Please Check Telephone Number Field.');", true);
                return false;
            }
            else
            {
        ...
        protected bool validateProspectiveFieldsNoEvent()
        {
            if (string.IsNullOrEmpty(prospective_txtFirstName.Value.ToString()) || prospective_txtFirstName.Value.Trim().ToString().Equals(""))
            {
                ScriptManager.RegisterStartupScript(Page, GetType(), "script2", "showProsModalErrorNoEvent('Please Check First Name Field');", true);
                return false;
            }
            else if (string.IsNullOrEmpty(prospective_txtSurname.Value.ToString()) || prospective_txtSurname.Value.Trim().ToString().Equals(""))
            {
                ScriptManager.RegisterStartupScript(Page, GetType(), "script2", "showProsModalErrorNoEvent('Please Check Surname Field.')", true);
                return false;
            }
            else if (string.IsNullOrEmpty(prospective_txtEmail.Value.ToString()) || prospective_txtEmail.Value.Trim().ToString().Equals(""))
            {
                ScriptManager.RegisterStartupScript(Page, GetType(), "script2", "showProsModalErrorNoEvent('Please Check Email Field.')", true);
                return false;
            }
            else if (string.IsNullOrEmpty(prospective_txtTelephone.Value.ToString()) || prospective_txtTelephone.Value.Trim().ToString().Equals(""))
            {
                ScriptManager.RegisterStartupScript(Page, GetType(), "script2", "showProsModalErrorNoEvent('Please Check Telephone Number Field.')", true);
                return false;
            }
            else
            {
