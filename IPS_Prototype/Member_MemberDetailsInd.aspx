<%@ Page Title="" Language="C#" MasterPageFile="~/IPS_Vertical.Master" AutoEventWireup="true" CodeBehind="Member_MemberDetailsInd.aspx.cs" Inherits="IPS_Prototype.Member_MemberDetailsInd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <label style="line-height: 1.5; font-size: 36px; font-family: 'Segoe UI'; font-weight: 400; margin: 10px 0;">Contribution History -  <label runat="server" id="lblIndName"></label></label>
    <hr />
    <br />
    ...
    <br />
       ...
       <asp:HiddenField ID="indName" runat="server" />
