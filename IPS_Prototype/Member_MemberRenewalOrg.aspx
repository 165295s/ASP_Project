...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
       <script>       
          // checkbox checked
            ...
            function showControlsAfterPostBackCheckedFirst() {
            ...
            handleDropDownChange1(dropdownValue);
        }

        function showControlsAfterPostBackCheckedInstallmentFailureFirst() {
            $("#ContentPlaceHolder1_grouping").css("display", "block");
            $('#dvInstallment').toggle();
            displayFailure();
            var dropdownValue = $('#ContentPlaceHolder1_Donor_Tier').val();
        ...
        function showControlsAfterPostBackCheckedFailureWithInstallment() {
            $("#ContentPlaceHolder1_grouping").css("display", "block");
            displayFailure();
            var dropdownValue = $('#ContentPlaceHolder1_Donor_Tier').val();
            handleDropDownChange1(dropdownValuerefreshed);       
        ...
        function showControlsAfterPostBackCheckedWithInstallment() {
            $("#ContentPlaceHolder1_grouping").css("display", "block");
            displaySuccess('Successfully Renewed!');
            var dropdownValue = $('#ContentPlaceHolder1_Donor_Tier').val();
            handleDropDownChange1(dropdownValuerefreshed);
